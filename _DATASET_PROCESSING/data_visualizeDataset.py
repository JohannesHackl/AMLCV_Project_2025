...
if __name__ == '__main__':
    ...
    visualize_random_samples(split='train', num_samples=3, save_dir='dataset_visualizations/00/train')
    
    # Visualize random samples from valid
    visualize_random_samples(split='valid', num_samples=3, save_dir='dataset_visualizations/00/valid')
    
    # Create comparison grid
    create_comparison_grid(split='train', num_samples=6, save_path='dataset_visualizations/00/train_grid.png')
